    ...
    try {
        ...
        try {
            ...
            if (servicesData.Services) {
                ...
                servicesData.Services.forEach(svc => {
                    ...
                    // Store description by name
                    if (svc.Description) {
                        servicesDescriptions[svc.Name] = svc.Description;
                    }
                });
        ...
        const enrichedTypes = appointmentTypes
            .map(st => {
                ...
                // Get description from /sale/services or fall back to session type description
                const description = servicesDescriptions[st.Name] || st.Description || null;
                ...
                return {
                    ...
                    Price: price,
                    // Description from /sale/services or session type
